...
export const slides = ref([{
    ...
    imageOne: getPublicPath('/images/small-beans.png'),
    imageTwo: getPublicPath('/images/small-beans-2.png'),
    role: "Developer",
  ...
  },
  {
    ...
    imageOne: getPublicPath('/images/youth-indicators.png'),
    imageTwo: getPublicPath('/images/youth-indicators-2.png'),
    role: "Architect, Designer, Developer",
  ...
  },
  {
    ...
    imageOne: getPublicPath('/images/onenorth.png'),
    imageTwo: getPublicPath('/images/burnsmcd.png'),
